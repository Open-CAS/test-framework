...
class Fio:
    def __init__(self, executor_obj):
        ...
        self.base_cmd_parameters: utils.fio_param.FioParam = None
        self.global_cmd_parameters: utils.fio_param.FioParam = None

    def create_command(self):
        self.command = ''
        self.base_cmd_parameters = utils.fio_param.FioParamCmd(self, self.executor)
        self.global_cmd_parameters = utils.fio_param.FioParamConfig(self, self.executor)
    ...
    def __str__(self):
        if len(self.jobs) > 0:
            ...
            fio_parameters = utils.fio_param.FioParamCmd(self, self.executor)
